...
class RQE(Model):
    def __init__(self, config):
        super(RQE, self).__init__(config)
    ...
    def _calc(self, x_a, y_a, z_a, x_c, y_c, z_c, s_b, x_b, y_b, z_b):
    ...
    def forward(self):
        ...
        score = self._calc(x_a, y_a, z_a, x_c, y_c, z_c, s_b, x_b, y_b, z_b)
